...
3. **Select the tech stack** — Choose based on game complexity:
   ...
   Default to `vite-vanilla` when unsure. Recommend `vite-phaser` for platformers, shooters, and anything needing physics or sprite animation. Vanilla is best for simple classics (Pong, Snake, Flappy Bird clones).
...
- Color palette: [primary, secondary, accent — names or descriptors]
- Style: [e.g., "minimalist geometric shapes, neon on dark background"]
- Animation feel: [snappy, smooth, bouncy, etc.]
